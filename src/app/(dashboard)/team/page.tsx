...
export default function TeamPage() {
  ...
  return (
    <div className="flex flex-col" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      {/* HU-06: Threshold edit modal (centered) */}
      {editingMonitor && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-5" onClick={() => setEditingMonitor(null)}>
          <div
            className="w-full max-w-sm rounded-2xl bg-white px-5 pt-5 pb-6 flex flex-col gap-4"
